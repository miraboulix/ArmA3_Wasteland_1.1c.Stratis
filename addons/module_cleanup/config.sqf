...
pvpfw_cleanUp_weaponHolderTimer = 60; // Weaponholders will be deleted after this time
...
pvpfw_cleanUp_ruinRadius = 250; // Destroyed Buildings will be deleted if no entity is in the specified range around them
